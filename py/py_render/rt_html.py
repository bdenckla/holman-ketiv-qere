...
# The other report in this repo, generated by py/main_render_uxlc_corrections.py,
# and the hand-written landing page that lists both.
UXLC_CORRECTIONS_PAGE = "uxlc_corrections.html"
UXLC_CORRECTIONS_NAV_LABEL = "UXLC suggestions"
...
def _top_nav_html(
    *,
    ...
    return (
        ...
        f'<a class="nav-link" href="{UXLC_CORRECTIONS_PAGE}">'
        f"{UXLC_CORRECTIONS_NAV_LABEL}</a>\n"
        "</nav>"
    )
